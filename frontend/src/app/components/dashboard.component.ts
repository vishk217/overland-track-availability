      ...
      <nav class="dashboard-nav">
        @if (subscriptionLoading()) {
          ...
          <div class="subscription-info">
            <p class="subscription-text">My goal is to make this service free for everyone. At the moment, a $2.99 subscription helps cover the costs of sending SMS messages and emails. Thank you for your support and understanding. </p>
